...
// EsclavoMotor.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEsclavoMotorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEsclavoMotorApp

CEsclavoMotorApp::CEsclavoMotorApp()
{
...
// Único objeto CEsclavoMotorApp

CEsclavoMotorApp theApp;


// Inicialización de CEsclavoMotorApp

BOOL CEsclavoMotorApp::InitInstance()
{
