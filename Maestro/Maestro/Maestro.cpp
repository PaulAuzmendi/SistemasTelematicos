...
// Maestro.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMaestroApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMaestroApp

CMaestroApp::CMaestroApp()
{
...
// Único objeto CMaestroApp

CMaestroApp theApp;


// Inicialización de CMaestroApp

BOOL CMaestroApp::InitInstance()
{
