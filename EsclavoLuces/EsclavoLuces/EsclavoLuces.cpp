...
// EsclavoLuces.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEsclavoLucesApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEsclavoLucesApp

CEsclavoLucesApp::CEsclavoLucesApp()
{
...
// Único objeto CEsclavoLucesApp

CEsclavoLucesApp theApp;


// Inicialización de CEsclavoLucesApp

BOOL CEsclavoLucesApp::InitInstance()
{
