...
// EsclavoAccionamientos.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEsclavoAccionamientosApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEsclavoAccionamientosApp

CEsclavoAccionamientosApp::CEsclavoAccionamientosApp()
{
...
// Único objeto CEsclavoAccionamientosApp

CEsclavoAccionamientosApp theApp;


// Inicialización de CEsclavoAccionamientosApp

BOOL CEsclavoAccionamientosApp::InitInstance()
{
